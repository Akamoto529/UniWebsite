...
export default class StaticGrid extends CanvasObject{
    ...
    handleClick(pos){
        for(let i = 0; i < this.elems.length; i++){
            ...
            if(pos.y >= elem.pos.y && pos.y <=elem.pos.y + this.elem_size && pos.x >= elem.pos.x && pos.x <=elem.pos.x + this.elem_size){
                return i;
            }
        }
        return -1;
